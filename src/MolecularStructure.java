...
public class MolecularStructure {
    ...
    public Molecule getMoleculeWithLowestBondStrength() {
        Molecule lowestStrengthMolecule = null;
        double lowestStrength = Double.MAX_VALUE;

        for (Molecule molecule : this.molecules) {
            if (molecule.getBondStrength() < lowestStrength) {
                lowestStrength = molecule.getBondStrength();
                lowestStrengthMolecule = molecule;
            }
        }

        return lowestStrengthMolecule;
    }
